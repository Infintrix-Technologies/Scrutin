...
#These three API are used to create Scrutin_Test by getting the data from Test_Template
@frappe.whitelist()
...
# These API are used to create Test_Template by getting data from specific Scrutin_Test
@frappe.whitelist()
