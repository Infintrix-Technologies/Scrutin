    ...
    <div className='px-32'>
      ...
      <div className='mt-10'>
        <table className='table-auto w-full'>
          ...
          <tbody className=''>
            <tr className='hover:bg-pink-100'>
              <td className='border px-4 py-2'>Software Engineer</td>
              <td className='border px-4 py-2'>2</td>
              <td className='border px-4 py-2'>5</td>
              <td className='border px-4 py-2'>2 Days ago</td>
              <td className='border px-4 py-2'>Sep 30, 2024</td>
              <td className='border px-4 py-2'>-</td>
              <td className='border px-4 py-2'></td>
            </tr><tr className='hover:bg-pink-100'>
              <td className='border px-4 py-2'>Software Engineer</td>
              <td className='border px-4 py-2'>2</td>
              <td className='border px-4 py-2'>5</td>
              <td className='border px-4 py-2'>2 Days ago</td>
